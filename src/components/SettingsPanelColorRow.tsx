...
const ColorRow: React.FC<ColorRowProps> = ({
  ...
  return (
    <div
      className={`settings-panel-color-row${
        isMobile ? " settings-panel-color-row-mobile" : ""
      }`}
      style={isMobile ? { minHeight: 110 } : {}}
    >
      <div
        ...
        onDragEnd={onDragEnd}
        onDrop={onDragEnd}
        style={isMobile ? { flexDirection: "column", minHeight: 80 } : {}}
      >
        {isMobile ? null : (
      ...
      {isMobile && (
        <div className="settings-panel-color-row-actions">
          <div className="color-row-delete">
            <button
              className="arrow-btn color-row-delete-btn"
              onClick={onDelete}
